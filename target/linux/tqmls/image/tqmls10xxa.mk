...
define Device/tqmls1043a-mbls10xxa-2g
  KERNEL_PATCHVER := 4.19
  KERNEL_NAME := Image
  KERNEL_SUFFIX := -kernel.itb
  KERNEL_INSTALL := 1
  FDT_LOADADDR = 0x90000000
  FILESYSTEMS := ext4 ubifs
  DEVICE_TITLE := TQ TQMLS1043A Module on MBLS10xxA (2GB-Variant)
  DEVICE_PACKAGES += \
    u-boot-tq-tqmls1043a-mbls10xxa-2g-qspi \
    u-boot-tq-tqmls1043a-mbls10xxa-2g-esdhc \
    layerscape-fman-ls1043ardb
  DEVICE_DESCRIPTION = \
    Build images for TQ LS1043 boards.
  DEVICE_DTS = freescale/fsl-tqmls1043a-mbls10xxa
...
IMAGES := general firmware_sdcard.img firmware_qspi.bin root.ubi
  ...
  IMAGE/root.ubi := append-ubi
endef
TARGET_DEVICES += tqmls1043a-mbls10xxa-2g

define Device/tqmls1046a-mbls10xxa-8g
  KERNEL_PATCHVER := 4.19
  KERNEL_NAME := Image
  KERNEL_SUFFIX := -kernel.itb
  KERNEL_INSTALL := 1
  FDT_LOADADDR = 0x90000000
  FILESYSTEMS := ext4 ubifs
  DEVICE_TITLE := TQ TQMLS1046A Module on MBLS10xxA (8GB-Variant)
  DEVICE_PACKAGES += \
    u-boot-tq-tqmls1046a-mbls10xxa-8g-qspi \
    u-boot-tq-tqmls1046a-mbls10xxa-8g-esdhc \
    layerscape-fman-ls1046ardb
  DEVICE_DESCRIPTION = \
    Build images for TQ LS1046 boards.
  DEVICE_DTS = freescale/fsl-tqmls1046a-mbls10xxa
...
IMAGES := general firmware_sdcard.img firmware_qspi.bin root.ubi
  ...
  IMAGE/root.ubi := append-ubi
endef
TARGET_DEVICES += tqmls1046a-mbls10xxa-8g
